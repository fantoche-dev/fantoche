...
export type { BlockIR, CodePoint, CodeRange, CodeTrack, CompiledElement, EditOp, SelectOp, TimelineIR, Track, TrackKey, } from './ir.js';
...
export type { FantocheDocument, PropValue, RangeSpec, TimelineItem, } from './schema.js';
