import type {SerializedVector2, SignalValue, SimpleSignal} from '@fantoche/core';
import {BBox, DEG2RAD} from '@fantoche/core';
 ...
 * import {makeScene2D, Circle} from '@fantoche/2d';
 *
 ...
 * import {makeScene2D, Circle} from '@fantoche/2d';
 * import {all, createRef, easeInCubic, easeOutCubic} from '@fantoche/core';
 *
 * export default makeScene2D('scene', function* (view) {
 *   const ref = createRef<Circle>();
 *   view.add(
