...
import type {Scene2D} from '@fantoche/2d';
import {SceneRenderEvent} from '@fantoche/core';
import {useApplication, useCurrentScene} from '@fantoche/ui';
...
export const NodeInspectorKey = '@fantoche/2d/node-inspector';
