...
```tsx
import {makeRef} from '@fantoche-dev/core';
...
```tsx
import {createRefArray, range} from '@fantoche-dev/core';
...
```tsx
import {createRefMap} from '@fantoche-dev/core';
...
```tsx
import {makeRef, makeRefs} from '@fantoche-dev/core';
