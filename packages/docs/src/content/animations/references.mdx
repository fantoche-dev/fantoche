...
```tsx
import {makeRef} from '@fantoche/core';
...
```tsx
import {createRefArray, range} from '@fantoche/core';
...
```tsx
import {createRefMap} from '@fantoche/core';
...
```tsx
import {makeRef, makeRefs} from '@fantoche/core';
