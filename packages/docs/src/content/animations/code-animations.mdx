...
import {makeScene2D, Code} from '@fantoche-dev/2d';
import {all, createRef, DEFAULT, waitFor} from '@fantoche-dev/core';
...
// highlight-start
import {Code, LezerHighlighter} from '@fantoche-dev/2d';
...
```tsx editor
import {makeScene2D, Code, CODE} from '@fantoche-dev/2d';
import {waitFor} from '@fantoche-dev/core';
...
```tsx editor
import {makeScene2D, Code, word, lines} from '@fantoche-dev/2d';
...
```tsx editor
import {makeScene2D, Code, replace, insert, remove} from '@fantoche-dev/2d';
import {createRef, waitFor} from '@fantoche-dev/core';
...
```tsx editor
import {makeScene2D, Code, lines} from '@fantoche-dev/2d';
import {createRef, DEFAULT, waitFor} from '@fantoche-dev/core';
...
```tsx editor
import {Code, Rect, makeScene2D} from '@fantoche-dev/2d';
import {createRef, createSignal} from '@fantoche-dev/core';
...
```ts
import {Code, LezerHighlighter, withDefaults} from '@fantoche-dev/2d';
import {parser} from '@lezer/rust';
