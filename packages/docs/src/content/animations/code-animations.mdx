...
import {makeScene2D, Code} from '@fantoche/2d';
import {all, createRef, DEFAULT, waitFor} from '@fantoche/core';
...
// highlight-start
import {Code, LezerHighlighter} from '@fantoche/2d';
...
```tsx editor
import {makeScene2D, Code, CODE} from '@fantoche/2d';
import {waitFor} from '@fantoche/core';
...
```tsx editor
import {makeScene2D, Code, word, lines} from '@fantoche/2d';
...
```tsx editor
import {makeScene2D, Code, replace, insert, remove} from '@fantoche/2d';
import {createRef, waitFor} from '@fantoche/core';
...
```tsx editor
import {makeScene2D, Code, lines} from '@fantoche/2d';
import {createRef, DEFAULT, waitFor} from '@fantoche/core';
...
```tsx editor
import {Code, Rect, makeScene2D} from '@fantoche/2d';
import {createRef, createSignal} from '@fantoche/core';
...
```ts
import {Code, LezerHighlighter, withDefaults} from '@fantoche/2d';
import {parser} from '@lezer/rust';
