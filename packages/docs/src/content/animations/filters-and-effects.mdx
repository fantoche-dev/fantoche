...
import {Img, Txt, makeScene2D} from '@fantoche/2d';
import {all, createRef, createSignal, linear} from '@fantoche/core';
...
import {makeScene2D, Img, blur} from '@fantoche/2d';
...
import {createSignal, linear, map, waitFor} from '@fantoche/core';
...
```tsx editor mode=preview ratio=3
import {Grid, Img, Layout, makeScene2D, Node, Rect, Txt} from '@fantoche/2d';
import {
  all,
  createRef,
  createSignal,
...
```tsx editor
// snippet source-in
import {Img, Node, makeScene2D} from '@fantoche/2d';
import {createRef, linear} from '@fantoche/core';
...
// snippet xor
import {Circle, Img, Node, makeScene2D} from '@fantoche/2d';
import {createRef, easeInOutSine, linear} from '@fantoche/core';
