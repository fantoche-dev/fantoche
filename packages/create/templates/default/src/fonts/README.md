...
- **Roboto** (latin, 400 + 700, normal) — designed by Christian Robertson,
  Google. License: **SIL Open Font License 1.1** (per Fontsource metadata,
  upstream source https://github.com/google/fonts, Roboto v51).
- Files fetched 2026-08-05 from the pinned Fontsource npm package:
